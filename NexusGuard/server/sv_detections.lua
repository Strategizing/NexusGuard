--[[
    NexusGuard Enhanced Detection System (server/sv_detections.lua)
    ...
    - Config and other module references provided during initialization
...
local Log = function(...)
    print('[NexusGuard Detections]', ...)
end

-- Initialize the module and dependency manager
function Detections.Initialize(cfg, logFunc, api)
    NexusGuardServer = api or { Config = {}, Utils = {}, Bans = {}, Discord = {}, Core = {} }
    Log = logFunc or (api and api.Utils and api.Utils.Log) or Log
